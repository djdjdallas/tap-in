...
export const ProfilePreview = ({ user, subtitles, links, getLinkIcon }) => {
  ...
  const handleImageUpload = async (e) => {
    try {
      ...
      // Get the public URL - Using the correct Supabase URL construction
      const baseUrl =
        "https://fgcfzzrmfavqcwslqilf.supabase.co/storage/v1/object/public";
      const publicUrl = `${baseUrl}/avatars/${fileName}`;
              ...
              <div className="absolute inset-[2px] bg-white rounded-full p-1">
                <img
                  ...
                  onError={(e) => {
                    ...
                    console.log("Attempted URL:", profileData.avatar_url);
